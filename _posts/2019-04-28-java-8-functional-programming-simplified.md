...
This approach is not new, we have been doing this for years. This function and high order function support is the base of functional programming.

What are lambdas, functional interfaces, etc? Well, they are just a way of doing old things in a new way.
...
The result of our `compute(…)` function depends on the passed function.
...
So, by the use of Lambdas, we can greatly simply our code.
...
It has only **ONE** abstract method because we have to pass function using **Lambda expression**. Due to this unique constraint of **having only one abstract method**, Java was able to correctly identify method signature and hence allowed us to use **Lambda expression**. So, **Lambda expression won’t work without this has only one abstract method** constraint.
...
Although you can write as many functional interfaces as you need, Java has also provided its own set of functional interfaces. Java has used them in its API’s and you are free to use them in your projects too. In fact, many libraries are using them too. Here are some examples: [Full List Here](https://docs.oracle.com/javase/8/docs/api/java/util/function/package-summary.html)
